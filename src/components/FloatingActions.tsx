    ...
    >
      ...
      >
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1a73e8] text-white shadow-lg shadow-black/15 transition hover:scale-105"
        >
          <MapGlyph className="h-6 w-6" />
        </a>
        <a
          href={`tel:${siteConfig.phoneTel}`}
          aria-label={`Ara: ${siteConfig.phoneDisplay}`}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-coral text-white shadow-lg shadow-black/15 transition hover:scale-105"
        >
        ...
        <a
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg shadow-black/15 transition hover:scale-105"
        >
      ...
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className={`flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg shadow-black/20 transition hover:scale-105 sm:h-16 sm:w-16 ${
          open ? "bg-ink rotate-45" : "bg-leaf animate-pop-in"
        }`}
      >
        {open ? (
